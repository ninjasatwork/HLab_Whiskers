classdef ClustTrial < handle
    ...
    methods (Access = public)
        function obj = ClustTrial(trial_num, cell_num, shank_num,...
                sample_rate, sweep_length_in_samples, spike_times, sourceFile)
            %
...
%                 r = s ./ obj.sampleRate;
    ...
    methods % Dependent property methods; cannot have attributes.
        ...
        function value = get.spikeRateInHz(obj)
            if  isempty(obj.spikeTimes) && obj.useFlag == 0
                value =[];
            elseif isempty(obj.spikeTimes) && obj.useFlag == 1
                value = 0;
            else
