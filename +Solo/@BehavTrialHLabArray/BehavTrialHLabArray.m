        ...
        function obj = BehavTrialArray(x, session_name)
            ...
            if nargin > 0
                ...
                for k=1:n_trials
                    ...
                    if isfield(x.saved, 'pole_disc_jyinactivationobj_response_history')
                    
                     trial_type = strcmp(x.saved.TrialTypeSection_previous_trial_types{k}, 'Go'); % 114 charcode for 'r', 108 for 'l'. 1 = S1 (go), 0 = S0 (nogo).
                    else 
                    ...
                    if isfield(x.saved_history, 'MotorsSection_no_pole_position_easy')

                    
                        nogo_position = x.saved_history.MotorsSection_no_pole_position_easy{k}; % In stepper motor steps.
                        go_position = x.saved_history.MotorsSection_yes_pole_position_easy{k}; % In stepper motor steps.
