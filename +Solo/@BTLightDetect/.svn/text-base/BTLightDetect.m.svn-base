...
classdef BTLightDetect < handle
    ...
    methods (Access = public)
        ...
        function obj = BTLightDetect(mouse_name, session_name, trial_num, trial_type,...
                response, trial_events, next_trial_events, varargin)
            %         function obj = BTLightDetect(mouse_name, session_name, trial_num, trial_type,...
