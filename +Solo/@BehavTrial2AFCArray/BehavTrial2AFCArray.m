...
classdef BehavTrial2AFCArray < Solo.BehavTrialArray 
% 
%     properties
%         mouseName = '';
%         sessionName = '';
...
%     
    methods (Access = public)
        function obj = BehavTrial2AFCArray(x, session_name)
            %
            ...
            if nargin > 0
                ...
                for k=1:n_trials
                    ...
                    trial_type = x.saved.TrialTypeSection_previous_sides(k) == 114; % 114 charcode for 'r', 108 for 'l'. 1 = S1 (go), 0 = S0 (nogo).
                    trial_correct = x.saved.stim_timing2AFCobj_hit_history(k);
                    ...
                    if ismember(session_type, {'Discrim_delay_move_lickport'})  % For now limit only to Discrim trials
...
% %         end
        function plot_scored_trials(obj, varargin)
            ...
            set(gca,'YTick',0:1,'YTickLabel',{'Yes(r)','No(l)'},'FontSize',fs,...
                'TickDir','out','Box','off');
            set(gcf,'Color','white')
