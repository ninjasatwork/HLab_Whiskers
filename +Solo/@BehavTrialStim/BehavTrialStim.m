...
%
%
classdef BehavTrialStim < handle
    ...
    methods (Access = public)
        ...
        function obj = BehavTrialStim(mouse_name, session_name, trial_num, trial_type,...
            ...
            %              motorPosition, nogoPosition, goPosition, virtualTrialPosition
            %
            if nargin == 0
                return
            end
            ...
            p.addParamValue('virtualTrialPosition', NaN, @isnumeric);
...
%             disp(p.Results)
            ...
            obj.virtualTrialPosition = p.Results.virtualTrialPosition;
        end
    ...
    methods % Dependent property methods; cannot have attributes.    
        ...
        function value = get.trialCorrect(obj)
            ...
            elseif strcmp(tt,'Nogo') && lick==0
                value = 1;
            elseif strcmp(tt,'Unrewarded_Go') && lick==1
                value = 1;
            elseif strcmp(tt,'Unrewarded_Go') && lick==0
                value = 0;
            elseif strcmp(tt,'Unpunished_Nogo') && lick==1
                value = 0;
            elseif strcmp(tt,'Unpunished_Nogo') && lick==0
                value = 1;
            elseif strcmp(tt,'Virtual_Unrewarded_Go')
                value = NaN;
            elseif strcmp(tt,'Virtual_Unpunished_Nogo')
                value = NaN;
            else
                disp('Unrecognized trial type')
                value = NaN;
            end
        end
