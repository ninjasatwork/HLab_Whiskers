...
%% Section 2: Crop files if necessary
%In the event we have a video we want to split into two separate video
%files, use the following code:
% cd(trackingInfo{1});
% videoCropper('dir','split',600,394,0,0) 
...
if exist(trackingInfo{2}, 'file') == 0
    disp('Transit failed')
else
